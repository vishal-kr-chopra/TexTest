      ...
      <Router>
        <div className="App">
          ...
          <div className="App-header">
            ...
            <Link to="/">
              <div className="heading">
                T<span id="subHeading">ex</span>T
                <span id="subHeading">Est</span>
              </div>
            </Link>
            ...
            render={() => {
              return (
                <div>
                  ...
                  <button className="reset" onClick={this.reload.bind(this)}>
                    RESET
                  </button>

                  <div id="res">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <font id="result" size="7">
                      Result
                    </font>
          ...
          <Route
            path="/Portal"
            component={() => {
              window.location = "http://172.31.134.15/";
              return null;
            }}
          />
          <Route
            path="/Profile"
            component={() => {
              window.location = "https://in.linkedin.com/in/vishal-kr-chopra";
              return null;
            }}
          />
